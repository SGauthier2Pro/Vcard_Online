    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(regex='(0|\\+33|0033)[1-9][0-9]{8}')], verbose_name='Phone')),
                ('mobile', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(regex='(0|\\+33|0033)[1-9][0-9]{8}')], verbose_name='Mobile')),
